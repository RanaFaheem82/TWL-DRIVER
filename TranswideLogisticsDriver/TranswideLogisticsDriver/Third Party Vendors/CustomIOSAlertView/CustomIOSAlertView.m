...
- (UIView *)createContainerView
{
    ...
    NSLog(@"createContainerView frame: %f,%f,%f,%f", (screenSize.width - dialogSize.width) / 2, (screenSize.height - dialogSize.height) / 2, dialogSize.width, dialogSize.height);
    ...
    [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionTransitionNone
                     animations:^{
                        ...
                        // CGSize keyboardSize = [[[notification userInfo] objectForKey:UIKeyboardFrameBeginUserInfoKey] CGRectValue].size;
                         ...
                         self->dialogView.frame = CGRectMake(0, 0, dialogSize.width, dialogSize.height);
